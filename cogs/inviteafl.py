...
class InviteTracker(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.tracked_guild_id = 1213699457233985587  # Replace with your server ID
        self.notification_channel_id = 1376299601358885066  # Replace with your notification channel ID
        self.invites = {}
